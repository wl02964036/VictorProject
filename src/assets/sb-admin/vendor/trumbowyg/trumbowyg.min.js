...
jQuery.trumbowyg = {
    ...
    function(e, t, n, a) {
        ...
        var i = function(o, r) {
            ...
            if (i.hasSvg = d !== !1, d !== !1 && (l.svgAbsoluteUseHref || 0 === a("#" + s, i.doc).length)) {
                if (null == d) {
                    var c = a("script[src]");
                    c.each(function(e, t) {
                        var n = t.src,
                ...
                if (null == d) console.warn("You must define svgPath: https://goo.gl/CfTY9U");
                    ...
                    u.id = s, i.doc.body.insertBefore(u, i.doc.body.childNodes[0]), a.ajax({
                        async: !0,
                        type: "GET",
            ...
            var g = i.doc.querySelector("base") ? t.location.href.split(/[?#]/)[0] : "";
        ...
        i.prototype = {
            ...
            buildEditor: function() {
                ...
                e.$ed.on("dblclick", "img", e.o.imgDblClickHandler).on("keydown", function(t) {
                    ...
                    e.$ta.val().match(/<.*>/) || e.$ed.html().match(/<.*>/) || setTimeout(function() {
                        var t = e.isIE ? "<p>" : "p";
            ...
            destroy: function() {
                ...
                e.isTextarea ? e.$box.after(e.$ta.css({
                    ...
                    height: ""
                }).removeClass(n + "editor").removeAttr("contenteditable").removeAttr("dir").html(e.html()).show()), e.$ed.off("dblclick", "img"), e.destroyPlugins(), e.$box.remove(), e.$c.removeData("trumbowyg"), a("body").removeClass(n + "body-fullscreen"), e.$c.trigger("tbwclose"), a(t).off("scroll." + e.eventNamespace + " resize." + e.eventNamespace), a(e.doc.body).off("keydown." + e.eventNamespace)
            },
            empty: function() {
            ...
            toggleSpan: function(e) {
                ...
                t.$ed.find("span").each(function() {
                    e === !0 ? a(this).attr("data-tbw-flag", !0) : a(this).attr("data-tbw-flag") ? a(this).removeAttr("data-tbw-flag") : a(this).contents().unwrap()
                })
            },
            dropdown: function(e) {
                var n = this,
            ...
            semanticTag: function(e, t, n) {
                ...
                n && (e = o, o = i), a(e, this.$ed).each(function() {
                    var e = !1,
                        n = a(this);
                    if (0 === n.contents().length) return !1;
                    r.range.startContainer.parentNode && r.range.startContainer.parentNode === this && (e = !0);
                    var i = a("<" + o + "/>");
                    i.insertBefore(n), t && a.each(n.prop("attributes"), function() {
                        i.attr(this.name, this.value)
                    }), i.html(n.html()), n.remove(), e === !0 && (r.range.selectNodeContents(i.get(0)), r.range.collapse(!1))
                })
            },
            createLink: function() {
                ...
                o.o.minimalLinks || a.extend(u, {
                    ...
                    if(t.indexOf('http://') == -1 && t.indexOf('https://') == -1 ){
                        alert('URL格式需 【https://】 或 【http://】 開頭');
                        return !1;
                    }
                    if(e.target != '' && e.target != '_blank' && e.target != '_self'){
                        alert('URL目標格式假如另開新視窗填【_blank】反之填【_self】');
                        return !1;
                    }
                     if(e.title !='' || e.text != ''){
                        if(t.indexOf('tcpass') != -1){
                            e.title = e.title || e.text;
                            e.target = '_self';
                        }else{
                            e.title = (e.title || e.text) +'(另開新視窗)';
                            e.target = '_blank';
                        }
                     }
                    var n = a(['<a href="', t, '">', e.text || e.url, "</a>"].join(""));
                    return e.title && n.attr("title", e.title), (e.target || o.o.defaultLinkTarget) && n.attr("target", e.target || o.o.defaultLinkTarget), o.range.deleteContents(), o.range.insertNode(n[0]), o.syncCode(), o.$c.trigger("tbwchange"), !0
                })
            },
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            a(t.getSelection().focusNode.parentNode).hasClass("trumbowyg-editor") || (d = t.getSelection().focusNode.parentNode);
            ...
            openModal: function(e, n, i) {
                ...
                return e && a("<span/>", {
                    text: e,
                    "class": l + "modal-title"
                }).prependTo(u), i && (a("input:first", u).focus(), s.buildModalBtn("submit", u), s.buildModalBtn("reset", u), d.height(u.outerHeight() + 10)), a(t).trigger("scroll"), s.$c.trigger("tbwmodalopen"), d
            },
